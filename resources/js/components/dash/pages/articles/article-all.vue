                        ...
                        <tr :key='index' v-for="(user, index) in rows">
                            ...
                            <td>
                                <button class="btn btn-success" title="Edit Article"
                                    @click="change_component($event, 'articleEdit')"><i
                                        class="fas fa-edit"></i></button>

                                <button class="btn btn-danger" id="id" title="Delete Article" data-toggle="modal"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <button class="btn btn-danger btn-flat my-4 mx-auto" data-dismiss="modal" type="button"
                            id="button-addon2" @click="deleteArticle($event)">Just Do It</button>
                    </div>
