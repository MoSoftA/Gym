    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        >
          ...
          <li class="nav-item">
            <a role="button" class="nav-link" @click="change_page('dashboard')">
          ...
          <li class="nav-item">
            <router-link to="/" exact class="nav-link" @click="change_page('dashboard')">
          ...
          <li class="nav-item has-treeview" @click="drop($event)">
            ...
            <ul class="nav nav-treeview" data-drop="1">
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('NavEdit')">
                  <i class="far fa-circle nav-icon"></i>
                  Navbar
                </a>
              </li>
              ...
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('features')">
                  <i class="far fa-circle nav-icon"></i>
                  Features
                </a>
              </li>
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('SlidersEdit')">
                  <i class="far fa-circle nav-icon"></i>
                  Slieders
                </a>
              </li>
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('AboutusEdit')">
                  <i class="far fa-circle nav-icon"></i>
                  About us
                </a>
              </li>
          ...
          <li class="nav-item has-treeview" data-drop="2" @click="drop($event)">
            ...
            <ul class="nav nav-treeview" data-drop="2">
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('userAll')">
                  <i class="far fa-circle nav-icon"></i> all users
                </a>
              </li>
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('userAdd')">
          ...
          <li class="nav-item has-treeview" data-drop="4" @click="drop($event)">
            ...
            <ul class="nav nav-treeview" data-drop="4">
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('trainerAll')">
                  <i class="far fa-circle nav-icon"></i> all Trainers
                </a>
              </li>
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('trainerAdd')">
                  <i class="far fa-circle nav-icon"></i> add trainer
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item has-treeview" data-drop="3" @click="drop($event)">
            ...
            <ul class="nav nav-treeview" data-drop="3">
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('articleAll')">
                  <i class="far fa-circle nav-icon"></i> all articles
                </a>
              </li>
              <li class="nav-item">
                <a role="button" class="nav-link" @click="change_page('articleAdd')">
                  <i class="far fa-circle nav-icon"></i> add articles
                </a>
              </li>
            </ul>
          </li>
...
export default {
  ...
  methods: {
    ...
    drop(e) {
      if (
        $(`ul[data-drop="${e.target.getAttribute("data-drop")}"]`).css(
          "display"
        ) == "block"
      ) {
        ...
        $(`ul[data-drop="${e.target.getAttribute("data-drop")}"]`).slideDown(
          400
        );
      }
    }
